...
Plus a smoke check that the REAL .gitlab-ci.yml currently passes — the one that
fires when someone bumps the library, since `.gitlab-ci.yml` is in the
python-tests `changes` list.
